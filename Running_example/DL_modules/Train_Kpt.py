...
register_coco_instances("mol_train", {}, r"Running_example/DL_modules/Data/Kpt/dataset_train.json",
                        r"Running_example/DL_modules/Data/Kpt/img_train")

MetadataCatalog.get("mol_train").keypoint_names = ["A", "B", "C"]
MetadataCatalog.get("mol_train").keypoint_flip_map = []

cfg = get_cfg()  # get default trainer configurations
cfg.MODEL.DEVICE = "cpu"  # set training device
cfg.merge_from_file(model_zoo.get_config_file("COCO-Keypoints/keypoint_rcnn_R_50_FPN_1x.yaml"))  # use a pretrained model
...
cfg.MODEL.ROI_HEADS.NUM_CLASSES = 1  # targets mol
...
cfg.MODEL.ROI_KEYPOINT_HEAD.NUM_KEYPOINTS = 3  # we have three reaction sites
